...
提高监控关键字的精确性。假如你的公司域名/ip 为 qq.com/1.1.1.1，那么最好在监控的关键字附上 qq.com/1.1.1.1 这样。类似的方法有很多（将自己公司的代码与其他公司区分开来还是比较容易的吧），目的是减少搜索结果，能提高精确性，降低人力。举个例子，如果你检测的是 `qiniu.com password` 你会发现每一轮都会有大量的更新，所以别用模糊的关键字。
